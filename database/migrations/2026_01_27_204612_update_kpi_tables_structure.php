...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('kpi_daily_detail', function (Blueprint $table) {
            ...
            $columnsToDrop = [];
            if (Schema::hasColumn('kpi_daily_detail', 'bobot_tercapai')) {
                $columnsToDrop[] = 'bobot_tercapai';
            }
            if (Schema::hasColumn('kpi_daily_detail', 'target_tercapai')) {
                $columnsToDrop[] = 'target_tercapai';
            }
