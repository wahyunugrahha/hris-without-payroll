        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Rekap Lembur Seluruh Karyawan</h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            {{-- ID Form ditambahkan untuk kontrol target via JS --}}
                            <form id="frmLaporan" action="{{ route('admin.lembur.cetakrekap') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <div class="row mt-2">
                                    <div class="col-6">
                                        <div class="form-group">
                                            {{-- Onclick: Ubah target form jadi _blank --}}
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            {{-- Onclick: Ubah target form jadi _self (download langsung) --}}
