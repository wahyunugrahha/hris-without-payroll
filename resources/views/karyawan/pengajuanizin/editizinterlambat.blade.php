...
@section('header')
    ...
    <div class="presensi-header">
        ...
        <span class="header-title">Edit Izin Terlambat</span>
...
@section('content')
    <div class="ios-form-container">
        <form method="POST" action="{{ route('pengajuanizin.updateizinterlambat', $dataizin->kode_izin) }}" id="frmeditizinterlambat">
            @csrf
            @method('PUT')
            <div class="ios-form-card">
                ...
                <div class="ios-form-group">
                    ...
                    <textarea name="keterangan" id="keterangan" class="ios-textarea validate" placeholder="Detail alasan izin terlambat" rows="4" required>{{ $dataizin->keterangan }}</textarea>
                </div>
...
@push('myscript')
    <script>
        $(function() {
            $("#frmeditizinterlambat").on('submit', function(e) {
