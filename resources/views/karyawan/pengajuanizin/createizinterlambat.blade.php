...
@section('header')
    ...
    <div class="presensi-header">
        ...
        <span class="header-title">Form Pengajuan Izin Terlambat</span>
...
@section('content')
    <div class="ios-form-container">
        <form method="POST" action="/pengajuanizin/storeizinterlambat" id="frmizinterlambat">
            @csrf
            <div class="ios-form-card">
                ...
                <div class="ios-form-group">
                    ...
                    <textarea name="keterangan" id="keterangan" class="ios-textarea validate" placeholder="Detail alasan izin terlambat"
...
@push('myscript')
    <script>
        $(function() {
            $("#frmizinterlambat").on('submit', function(e) {
